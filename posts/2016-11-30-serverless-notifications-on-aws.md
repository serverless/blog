...
I know that "Internet of Things" sounds strange to be used in a website, but it supports WebSockets, is very easy to use, and unlike [Amazon SNS](https://www.serverless.com/amazon-sns/) (Simple Notification Service) it supports WebSockets. Win!
