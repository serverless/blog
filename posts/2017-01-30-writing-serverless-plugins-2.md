...
## Copy Data Plugin
We can start by defining the command in a new class as shown in the previous article (link link link). I imagine the command would have two steps or lifecycle events - one for downloading the data and one for uploading them. It could look something like this:
